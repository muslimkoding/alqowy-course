            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">    
                        ...
                        <div>
                            <p class="text-slate-500 text-sm mb-2">Subscription start at :</p>
                            @if ($subscribeTransaction->subscription_start_date == '')
                                <span class="bg-orange-500 py-2 px-3 rounded-full w-fit">Menunggu Approve</span>
                            @else
                                
                            <h3 class="text-indigo-950 text-xl font-bold bg-green-500 py-2 px-3 rounded-full w-fit">{{ $subscribeTransaction->subscription_start_date }}</h3>
                            @endif
                        </div>
                        <div class="">
