        ...
        <nav class="flex justify-between items-center pt-6 px-[50px]">
            ...
            <div class="flex gap-[10px] items-center">
              ...
              <div class="w-[56px] h-[56px] overflow-hidden rounded-full flex shrink-0">
                  <a href="{{ route('dashboard') }}"><img src="{{ Storage::url(Auth::user()->avatar) }}" class="w-full h-full object-cover" alt="photo"></a>
              </div>
          </div>
            @endauth
            @guest
        ...
        <div class="video-player relative flex flex-nowrap gap-5">
            ...
            <div class="video-player-sidebar flex flex-col shrink-0 w-[330px] h-[470px] bg-[#F5F8FA] rounded-[20px] p-5 gap-5 pb-0 overflow-y-scroll no-scrollbar">
                ...
                <div class="flex flex-col gap-3">
                    <div class="group p-[12px_16px] flex items-center gap-[10px] bg-[#3525B3] rounded-full hover:bg-[#E9EFF3] transition-all duration-300">
                        ...
                        <a href="{{ route('front.details', $course) }}">
                          <p class="font-semibold group-hover:text-white transition-all duration-300 text-white">Course Trailer</p>
                        </a>
                        
                    </div>
                    
                    @forelse ($course->course_videos as $item)
                    <div class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3]  rounded-full hover:bg-[#3525B3] transition-all duration-300">
                      ...
                      <a href="{{ route('front.learning', [$course, 'courseVideoId' => $item->id]) }}">
                        <p class="font-semibold group-hover:text-white transition-all duration-300 text-black">{{ $item->name }}</p>
                      </a>
                  </div>
                    @empty
